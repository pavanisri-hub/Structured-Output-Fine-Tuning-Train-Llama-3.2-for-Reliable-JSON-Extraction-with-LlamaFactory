...
Synthetic document E18 includes mixed date notation, subtotal lines, and footer comments.

## Expected JSON
```json
{"document_type":"invoice","id":"E18","currency":"USD","total":1234.56}
```

## Model actual output
```text
Here is the extracted JSON: {"document_type":"invoice","id":"E18"} Additional explanation...
```
